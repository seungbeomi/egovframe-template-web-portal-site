...
<body onLoad="fn_egov_initl_qnacn();">
	...
	<!-- 작성비밀번호확인 팝업 -->
    <div class="popup POP_CONFIRM_PWD" style="display: block;">
        <div class="pop_inner">
            ...
            <div class="pop_container">
                ...
                <div class="btn_area al_c pt20">
                    ...
                    <a href="#LINK" class="btn btn_skyblue_h46 w_100" onclick="JavaScript:fn_egov_cancel_qnapassword(); return false;"><spring:message code='button.reset' /></a><!-- 취소 -->
                </div>
            </div>
        </div>
    </div>
