                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
                                ...
                                <div class="board_list_top">
                                    ...
                                    <div class="right_col">
                                        <a href="#LINK" class="btn btn_blue_46 w_100" onclick="javascript:fncAuthorGroupDeleteList()" style="selector-dummy:expression(this.hideFocus=false);">삭제</a><!-- 삭제 -->
                                        <a href="#LINK" class="btn btn_blue_46 w_100" onclick="javascript:fncAddAuthorGroupInsert()" style="selector-dummy:expression(this.hideFocus=false);">등록</a><!-- 등록 -->
                                    </div>
                                </div>
